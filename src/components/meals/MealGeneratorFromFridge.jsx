...
/**
 * Générateur de repas basé sur les aliments disponibles dans le frigo
 * Ce composant s'utilise à l'intérieur d'un FridgeProvider
 */
const MealGeneratorFromFridge = () => {
...
export default MealGeneratorFromFridge;